...
| [Balance Monitoring](./manual-balance-monitoring.md) | Userscript request, credential, response, and evidence contracts | Active |
...
| [Account Creation](./account-creation.md) | Same-origin preview, mandatory group assignment, transient-key creation, idempotency, and readback contracts | Active |
